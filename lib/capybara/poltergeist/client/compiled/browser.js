Poltergeist.Browser = (function() {
  ...
  Browser.prototype.arm_js_confirm_accept_handling = function() {
    var _this = this;
    this.page.onConfirm = function(msg) {
      console.log("arm_js_confirm_accept_handling", msg);
      _this.confirm_messages.push(msg);
      _this.page.onConfirm = null;
      return true;
    };
    return this.sendResponse("success");
  };

  Browser.prototype.arm_js_confirm_reject_handling = function() {
    var _this = this;
    this.page.onConfirm = function(msg) {
